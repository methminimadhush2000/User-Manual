import{_ as a,c as i,a0 as n,o as t}from"./chunks/framework.CoVXEd1Z.js";const o=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{},"headers":[],"relativePath":"new.md","filePath":"new.md"}'),l={name:"new.md"};function e(p,s,h,k,r,d){return t(),i("div",null,s[0]||(s[0]=[n(`<h1 id="getting-started" tabindex="-1">Getting Started <a class="header-anchor" href="#getting-started" aria-label="Permalink to &quot;Getting Started&quot;">​</a></h1><h2 id="logging-in-to-the-system" tabindex="-1">Logging in to the System <a class="header-anchor" href="#logging-in-to-the-system" aria-label="Permalink to &quot;Logging in to the System&quot;">​</a></h2><p>**1. **</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\`\`\`js{4}</span></span>
